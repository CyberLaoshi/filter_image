...
class Filter:
    def apply_filter(self, red, green, blue):
        raise NotImplementedError

    def apply_to_pixel(self, img):
...
class GreenFilter(Filter):
    ...
    def apply_filter(self, red: int, green: int, blue: int) -> tuple[int, int, int]:
...
class Intensifier(Filter):
    ...
    def apply_filter(self, red: int, green: int, blue: int) -> tuple:
